...
class ReplaceTextWidget(QWidget):
    ...
    def __initUi(self, widget):
        ...
        self.__replaceLineEdit.setFixedWidth(200)
        ...
        btns = [self.__replaceBtn, self.__replaceAllBtn]
        ...
        self.__icon = QLabel()
        self.__icon.setPixmap(QPixmap('ui/icons/16x16/cil-transfer.png'))
    ...
    def __replace(self):
        ...
        if cur:
            ...
            if old_text:
                ...
                self.__text_cursors.remove(cur)
