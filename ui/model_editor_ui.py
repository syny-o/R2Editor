...
"}")
        ...
        self.ui_edit.setIcon(icon1)
        self.ui_edit.setCheckable(False)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/16x16/icons/16x16/cil-task.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ui_check_coverage.setIcon(icon2)
        ...
        self.ui_check_html_report.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/16x16/icons/16x16/cil-cloud-download.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ui_update_requirements.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/20x20/icons/20x20/cil-plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ui_new_requirements.setIcon(icon5)
...
"}")
        ...
        self.ui_btn_goBack.setIcon(icon6)
