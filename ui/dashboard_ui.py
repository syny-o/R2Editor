...
"}*/")
        ...
        self.uiDashboardFrameLeft = QtWidgets.QFrame(Form)
        self.uiDashboardFrameLeft.setMaximumSize(QtCore.QSize(800, 16777215))
        self.uiDashboardFrameLeft.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.uiDashboardFrameLeft.setFrameShadow(QtWidgets.QFrame.Raised)
        self.uiDashboardFrameLeft.setObjectName("uiDashboardFrameLeft")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.uiDashboardFrameLeft)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setSpacing(0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.frame_logo_2 = QtWidgets.QFrame(self.uiDashboardFrameLeft)
        ...
        self.frame_logo_2.setStyleSheet("")
        ...
        self.uiLabelLogo = QtWidgets.QLabel(self.frame_logo_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.uiLabelLogo.sizePolicy().hasHeightForWidth())
        self.uiLabelLogo.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        ...
        self.uiLabelLogo.setFont(font)
        self.uiLabelLogo.setStyleSheet("")
        self.uiLabelLogo.setObjectName("uiLabelLogo")
        self.horizontalLayout_3.addWidget(self.uiLabelLogo, 0, QtCore.Qt.AlignHCenter)
        self.verticalLayout_2.addWidget(self.frame_logo_2, 0, QtCore.Qt.AlignHCenter)
        self.frame_4 = QtWidgets.QFrame(self.uiDashboardFrameLeft)
        ...
        self.uiLayoutRecentProjects = QtWidgets.QHBoxLayout()
        self.uiLayoutRecentProjects.setObjectName("uiLayoutRecentProjects")
        self.verticalLayout_6.addLayout(self.uiLayoutRecentProjects)
        self.verticalLayout_2.addWidget(self.frame_4)
        self.frame_top = QtWidgets.QFrame(self.uiDashboardFrameLeft)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.frame_2 = QtWidgets.QFrame(self.uiDashboardFrameLeft)
        ...
        self.horizontalLayout_8.addWidget(self.uiDashboardFrameLeft)
        self.uiDashboardFrameRight = QtWidgets.QFrame(Form)
        self.uiDashboardFrameRight.setStyleSheet("/*QWidget, QFrame, QPushButton, QLineEdit{\n"
...
"    color: rgb(200, 200, 200);\n"
"}*/")
        self.uiDashboardFrameRight.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.uiDashboardFrameRight.setFrameShadow(QtWidgets.QFrame.Raised)
        self.uiDashboardFrameRight.setObjectName("uiDashboardFrameRight")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.uiDashboardFrameRight)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frame_10 = QtWidgets.QFrame(self.uiDashboardFrameRight)
        ...
        self.frame_5 = QtWidgets.QFrame(self.uiDashboardFrameRight)
        ...
        self.frame_7 = QtWidgets.QFrame(self.uiDashboardFrameRight)
        self.frame_7.setMinimumSize(QtCore.QSize(0, 100))
        self.frame_7.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_7.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_7.setObjectName("frame_7")
        self.verticalLayout.addWidget(self.frame_7)
        self.frame_6 = QtWidgets.QFrame(self.uiDashboardFrameRight)
        self.frame_6.setMaximumSize(QtCore.QSize(16777215, 0))
        self.frame_6.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_6.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_6.setObjectName("frame_6")
        self.verticalLayout.addWidget(self.frame_6)
        self.horizontalLayout_8.addWidget(self.uiDashboardFrameRight)
    ...
    def retranslateUi(self, Form):
        ...
        self.uiLabelLogo.setText(_translate("Form", "R2"))
