...
"}")
        ...
        self.uiComboAutosave = QtWidgets.QComboBox(self.frame_32)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.uiComboAutosave.sizePolicy().hasHeightForWidth())
        self.uiComboAutosave.setSizePolicy(sizePolicy)
        self.uiComboAutosave.setObjectName("uiComboAutosave")
        self.uiComboAutosave.addItem("")
        self.uiComboAutosave.addItem("")
        self.uiComboAutosave.addItem("")
        self.uiComboAutosave.addItem("")
        self.uiComboAutosave.addItem("")
        ...
        self.uiComboAutosave.addItem("")
        self.uiComboAutosave.addItem("")
        self.horizontalLayout_23.addWidget(self.uiComboAutosave)
        self.verticalLayout_15.addWidget(self.frame_32, 0, QtCore.Qt.AlignTop)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_11.setText(_translate("Form", "Autosave (minutes)"))
        self.uiComboAutosave.setItemText(0, _translate("Form", "Off"))
        self.uiComboAutosave.setItemText(1, _translate("Form", "1"))
        self.uiComboAutosave.setItemText(2, _translate("Form", "2"))
        self.uiComboAutosave.setItemText(3, _translate("Form", "5"))
        self.uiComboAutosave.setItemText(4, _translate("Form", "10"))
        self.uiComboAutosave.setItemText(5, _translate("Form", "15"))
        self.uiComboAutosave.setItemText(6, _translate("Form", "30"))
        self.uiComboAutosave.setItemText(7, _translate("Form", "45"))
        self.uiComboAutosave.setItemText(8, _translate("Form", "60"))
        ...
        self.ui_cb_database.setItemText(2, _translate("Form", "36677@slivmi-liv9db.ad.trw.com"))
