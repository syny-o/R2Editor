...
for signal in ("FaultRecoveryRequest", "DataStorageRead", "MotorVoltageLeft", "MotorVoltageRight", "MotorCurrentLeft", "MotorCurrentRight", "HostSoftwareVersion", "VariantItem"):
    for number in range(0, 99):
        if (signal != "DataStorageRead" and signal != "VariantItem") and number > 20:
            continue        
        if number < 10:
